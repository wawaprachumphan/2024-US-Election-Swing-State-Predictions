...
เมื่อเจาะลงไปในแต่ละรัฐ Swing State จะเห็นถึงคะแนนความนิยมต่อพรรคการเมืองในแต่ละรัฐแตกต่างกันไป และสามารถจัดกลุ่มความนิยมในการโหวตแต่ละพรรคการเมืองได้ดังนี้ 
  ...
  • Red State : หรือรัฐที่สนับสนุนพรรครีพับลิกัน ได้แก่ แอริโซนา (AZ), จอร์เจีย (GA) และนอร์ทแคโรไลนา (NC) 
  เป็นฐานเสียงหลักของพรรครีพับลิกันมาอย่างสม่ำเสมอตั้งแต่ปี 2000 - 2016 และถูกพรรคเดโมแครตเอาชนะได้ในปี 2020 
...
![](https://github.com/NichareeInt/picture/blob/main/image10.jpg)
  ...
  • Blue State : หรือรัฐที่สนับสนุนพรรคเดโมแครต ได้แก่ มิชิแกน (MI), เพนซิลเวเนีย (PA) และวิสคอนซิน (WI) 
  เป็นฐานเสียงหลักของพรรคเดโมแครต และตอกย้ำให้เห็นถึงความนิยมต่อพรรคเดโมแครตยิงขึ้นในปีที่ บารัก โอบามา (2008 - 2012) ก้าวเข้ามาเป็นแคนดิเดตประธานาธิบดี  
  ในขณะเดียวกันคะแนนเสียงก็ได้ถูกพรรครีพับลิกันแย่งชิงไปได้ในปี 2018
...
![2_7](https://github.com/user-attachments/assets/fd1d0f6c-77f7-4d24-b719-3a67f01e2904)
  ...
  • Purple State : หรือรัฐที่ยังไม่ตัดสินใจ ได้แก่ เนวาดา (NV) เป็นรัฐที่ยังไม่สามารถระบุได้ว่าเป็นรัฐที่สนับสนุนพรรคใด 
  เพราะคะแนนโหวตระหว่างพรรครีพับลิกันและพรรคเดโมแครตก็ขับเขี่ยวสลับกันแพ้ชนะเรื่อยมา 
...
จากกราฟแสดงให้เห็นความสัมพันธ์ระหว่างผลรวมการเลือกตั้งระดับประเทศ National และรัฐ Swing State พบว่ากราฟมีการแปรผันตรงต่อกัน โดยหากปีนั้นๆ พรรคการเมืองใดได้เป็นแชมป์ ก็มักจะได้รับชัยชนะในรัฐ Swing State ด้วย สรุปได้ว่า ผลการเลือกตั้งในรัฐ Swing State ส่งผลโดยตรงต่อการได้รับชัยชนะระดับชาติ 
...
4. จากการคาดการณ์พบว่าประชาชนผู้มีสิทธิเลือกตั้งเพิ่มขึ้น โดยใช้ Model Logistic Reregression คาดการณ์ว่าผู้ Register และ Vote มีแนวโน้มเพิ่มขึ้น ตามจำนวนเทรนด์ประชากรที่เพิ่มขึ้น เมื่อใช้ Model Logistic Reregression ในการ Predict ต่อว่าแต่ละรัฐ Swing State พรรคใดจะเป็นผู้ชนะ โดยผลปรากฎ พรรคเดโมแครตเอาชนะพรรครีพับลิกัน ไป 4 ต่อ 3 รัฐ โดยมีค่าความแม่นยำ หรือ Accuracy อยู่ที่ 88.89% และมีค่า Confusion Matrix: [[3 0] [1 5]] โดยแต่ละรัฐปรากฏผู้ชนะ ดังนี้ 

  • แอริโซนา (AZ) ผู้ชนะได้แก่ พรรครีพับลิกัน

  • จอร์เจีย (GA)  ผู้ชนะได้แก่ พรรครีพับลิกัน

  • มิชิแกน (MI)  ผู้ชนะได้แก่ พรรคเดโมแครต

  • นอร์ทแคโรไลนา (NC)  ผู้ชนะได้แก่ พรรครีพับลิกัน 

  • เนวาดา (NV) ผู้ชนะได้แก่ พรรคเดโมแครต

  • เพนซิลเวเนีย (PA) ผู้ชนะได้แก่ พรรคเดโมแครต

  • วิสคอนซิน (WI)  ผู้ชนะได้แก่ พรรคเดโมแครต
